...
public:
	...
	UINT PlayAnimation(UINT fileLine, LAnimation::LAnimationStyle = LAnimation::LAnimationStyle::None, UINT addValue = 0);	//返回附加数据addValue
	...
	UINT GetAddValue() { return m_AddValue.m_Val; }
